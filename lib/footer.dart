    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: const <Widget>[
            Expanded(
              child: NormalFlutterImage(logo: "images/flutter_logo2.webp"),
            ),
            Expanded(
              child: NormalFirebaseImage(logo: "images/firebase2.webp"),
            ),
          ],
        ),
        Row(
          ...
          children: const <Widget>[
            Expanded(
              child: NormalCloudFlareImage(logo: "images/cloudflare.webp"),
            ),
          ],
        ),
      ],
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: const <Widget>[
            WideFlutterImage(logo: "images/flutter_logo2.webp"),
            WideCloudFlareImage(logo: "images/cloudflare.webp"),
            WideFirebaseImage(logo: "images/firebase2.webp"),
          ],
        ),
      ],
    );
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: const <Widget>[
            Expanded(
              child: SmallFooterImage(logo: "images/flutter_logo2.webp"),
            ),
            Expanded(
              child: SmallFooterImage(logo: "images/firebase2.webp"),
            ),
          ],
        ),
        Row(
          ...
          children: const <Widget>[
            Expanded(
              child: SmallFooterImage(logo: "images/cloudflare.webp"),
            ),
          ],
        ),
      ],
